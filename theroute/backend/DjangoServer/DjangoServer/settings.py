...
SECRET_KEY = "django-insecure-g#b)$vf3b582f=7413j%^5sr4#fq=@iu)p49$z0!nf%ff*hcma"
...
DATABASES = {
    "default": {
        ...
        "NAME": BASE_DIR / "TheRoute.sqlite3",
        "OPTIONS": {
...
# Basic logging setup (no DEBUG level logs)
LOGGING = {
    'version': 1,
    ...
    'loggers': {
        'django': {
            'handlers': ['console'],
            'level': 'WARNING',  # No debug-level logs
            'propagate': True,
        },
    },
}
